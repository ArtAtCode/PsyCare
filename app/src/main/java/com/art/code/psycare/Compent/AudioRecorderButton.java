...
import com.art.code.psycare.Manager.AudioDialogManage;
import com.art.code.psycare.Manager.AudioManage;
...
public class AudioRecorderButton extends AppCompatButton implements AudioManage.AudioStateListener {
    ...
    private boolean mReady;    // 是否触发onLongClick是否长按
    ...
    public AudioRecorderButton(final Context context, AttributeSet attrs) {
        ...
        setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                mAudioManage.prepareAudio();//在长时间按住后prepareAudio
                //return true;
                return false;//返回false表示不消耗时间
            }
        });
        ...
        mAudioManage.setOnAudioStatusUpdateListener(new AudioManage.OnAudioStatusUpdateListener() {
            ...
            public void onUpdate(double db, long time) {
               ...
               // audioDialogManage.mIcon.getDrawable().setLevel((int) (3000 + 6000 * db / 100));//先不用原来的，测试一下
                audioDialogManage.mIcon.getDrawable().setLevel( 2);
            }
...
//构造器结束
    ...
    //                audioDialogManage.updateCurTime(TimeUtils.countDown(mTime));
                    audioDialogManage.updateCurTime(String.valueOf(mTime));//lmj：这好像是显示录了多长时间
                    break;
